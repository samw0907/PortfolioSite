...
const Home = () => {
  ...
  return (
    <div className="relative flex flex-col min-h-full z-0">
      ...
      <div
        className="relative rounded-full w-40 h-40 mb-6"
      >
        ...
        />
          ...
          <div
            className="w-[336px] sm:w-[384px] overflow-hidden rounded-xl bg-white/70 dark:bg-[#0f172a]/70 backdrop-blur-md px-5 py-3 relative group mt-6"
            style={{
