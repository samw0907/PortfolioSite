      ...
      <section className="section">
        <div className="container-max">
          <div className="grid gap-10 lg:grid-cols-12 items-start">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-3 max-w-2xl">
                ...
                <div className="stat">
                  ...
                  <div className="stat-value">React · TS · Node</div>
                </div>
                <div className="stat">
            ...
            {/* Right column: minimal “editorial” card */}
            <div className="lg:col-span-4">
              <div className="card">
                <h2 className="card-title">Now</h2>
                <p className="card-text">
                  Building portfolio-ready projects with modern tooling: TypeScript, testing, CI/CD,
                  and clean UI structure. Always optimizing for readability and maintainability.
                </p>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="card">
              ...
              <p className="card-text">
                Activity-tracking app for triathletes with a full CRUD dashboard, personal records, and a CI/CD pipeline.
              </p>
            ...
            <div className="card">
              ...
              <p className="card-text">
                Concept project for remediation / stabilization tracking based on real-world consulting workflows.
              </p>
              <Link to="/projects" className="link">
                View details
              </Link>
