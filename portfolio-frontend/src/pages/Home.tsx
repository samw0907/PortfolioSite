...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* ✅ Main Hero Section */}
      <div className="relative bg-transparent flex-grow">
        {/* ✅ Particle Background */}
        ...
        {/* ✅ HERO SECTION */}
        <section className="relative z-10 font-josefin flex flex-col items-center justify-center text-center px-4 py-12 bg-transparent">
          <motion.div
