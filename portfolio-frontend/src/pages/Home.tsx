...
const Home = () => {
  ...
  return (
    ...
    <div className="relative bg-transparent">
      ...
      {/* ✅ HERO SECTION — fully transparent wrapper */}
      <section className="relative z-10 font-josefin min-h-screen flex flex-col items-center justify-center text-center px-4 py-12 bg-transparent">
        <motion.div
        ...
        >
          {/* ✅ Profile Image Block */}
          <div className="p-2 rounded-xl bg-white/70 dark:bg-[#0f172a]/70 backdrop-blur-md">
            <img
              src={BWPhotoEdit}
              alt="Profile"
          ...
          {/* ✅ Name & Role */}
          <div className="px-6 py-4 rounded-xl bg-white/70 dark:bg-[#0f172a]/70 backdrop-blur-md">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light tracking-wide text-gray-900 dark:text-white">
              SAM WILLIAMSON
            </h1>
            <p className="text-lg sm:text-xl text-teal-600 dark:text-teal-400 font-light tracking-wide font-medium mt-2">
          ...
          {/* ✅ Tech Stack Carousel */}
          <div
            className="w-[336px] sm:w-[384px] overflow-hidden rounded-xl bg-white/70 dark:bg-[#0f172a]/70 backdrop-blur-md px-4 py-2 relative group"
            style={{
          ...
          {/* ✅ What I Do */}
          <div className="px-6 py-6 rounded-xl bg-white/70 dark:bg-[#0f172a]/70 backdrop-blur-md text-center">
